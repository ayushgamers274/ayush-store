  ...
  safe(function () {
    document.addEventListener('click', function (e) {
      ...
      if (act === 'email-me') {
        ...
        if (/Android|iPhone|iPad|Mobile|Opera Mini/i.test(navigator.userAgent)) {
          window.location.href = 'mailto:' + mail + '?subject=' + subj + '&body=' + body;
        } else {
          window.open('https://mail.google.com/mail/?view=cm&fs=1&to=' + encodeURIComponent(mail) + '&su=' + subj + '&body=' + body, '_blank', 'noopener');
        }
      }
      if (act === 'admin-tab') {
